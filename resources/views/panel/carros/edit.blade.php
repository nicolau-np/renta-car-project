    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <form action="{{ '/panel/carros/'.$carro->id }}" method="post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-2 mb-2">
                                ...
                                <input class="form-control" type="text" name="matricula" placeholder="Matrícula"
                                    value="{{ old('matricula', $carro->matricula) }}" />
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <select name="marca" class="form-control">
                                    ...
                                    @foreach (config('constants.CATEGORIAS_DE_CARROS') as $key => $item)
                                        <option value="{{ $item }}"
                                            {{ old('marca', $carro->marca) == $item ? 'selected' : null }}>
                                            {{ $item }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <select name="caixa_automovel" class="form-control">
                                    ...
                                    @foreach (config('constants.CAIXA_AUTOMOVEL') as $key => $item)
                                        <option value="{{ $item }}"
                                            {{ old('caixa_automovel', $carro->caixa_automovel) == $item ? 'selected' : null }}>
                                            {{ $item }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <input class="form-control" type="text" name="lugares" placeholder="Lugares"
                                    value="{{ old('lugares', $carro->lugares) }}" />
                             ...
                             <div class="col-md-2 mb-2">
                                ...
                                <input class="form-control" type="text" name="kilometragem" placeholder="Kilometragem"
                                    value="{{ old('kilometragem', $carro->kilometragem) }}" />
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <input class="form-control" type="text" name="preco_por_dia" placeholder="Preço por dia"
                                    value="{{ old('preco_por_dia', $carro->preco_por_dia) }}" />
